...
export default class PlayExtremeScene extends Phaser.Scene {
  constructor() {
    super("PlayExtremeScene");
  }

  preload() {
    // Assets gambar
    this.load.image("bg neraka", "assets/extreme/bg neraka.png");
    this.load.image("board batu", "assets/extreme/board batu.png");
    ...
    this.load.image("meja neraka", "assets/extreme/meja neraka.png");
  ...
  create() {
    ...
    this.add.image(centerX, centerY, "bg neraka").setDisplaySize(width, height);
    this.add.image(centerX, height - 410,"meja neraka").setScale(1.2).setDepth(0);
