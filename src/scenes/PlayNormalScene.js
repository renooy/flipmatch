...
export default class PlayNormalScene extends Phaser.Scene {
  constructor() {
  ...
  preload() {
    // Assets gambar
    this.load.image("bg tanah", "assets/normal/bg taneh.png");
    this.load.image("board batu", "assets/normal/board batu.png");
    ...
    this.load.image("meja batu", "assets/normal/mejabatu.png");
  ...
  create() {
    ...
    this.add.image(centerX, centerY, "bg tanah").setDisplaySize(width, height);
    this.add.image(centerX, height - 420,"meja batu").setScale(1.2).setDepth(0);
    this.add.image(centerX, centerY - 90, "board batu").setScale(0.85).setDepth(1);
  ...
  createCards(centerX, centerY) {
    ...
    const cardTextures = ["card1", "card2", "card3","card4", "card5","card1", "card2", "card3","card4", "card5"];
